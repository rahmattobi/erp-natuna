                    ...
                    <div class="card-body">
                        <form action="{{ route('invoice.action') }}" method="POST" class="user">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="repeat_count" name="inst_plan" class="form-select form-control form-control-select" aria-label="Default select example" required>
                                        <option selected disabled>Instalment Plan</option>
                                            <option value="1">1x Pembayaran</option>
                                ...
                                <input name="tempo" value="{{ now()->addMonth()->subDay()->toDateString() }}"  type="text" class= "form-control form-control-select @error('tempo') is-invalid @enderror" hidden>
