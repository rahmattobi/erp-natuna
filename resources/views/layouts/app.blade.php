...
<head>
    ...
    <link href='{{ asset('fullcalendar/fullcalendar/packages/core/main.css') }}' rel='stylesheet' />
    <link href='{{ asset('fullcalendar/fullcalendar/packages/daygrid/main.css') }}' rel='stylesheet' />
    ...
    <!-- Style -->
    <link rel="stylesheet" href="{{ asset('fullcalendar/css/style.css')}}">
...
<body id="page-top">
    ...
    <script src="{{ asset('adminAssets/js/demo/chart-pie-demo.js') }}"></script>
     ...
     {{-- read more text if text more then 200 character --}}
